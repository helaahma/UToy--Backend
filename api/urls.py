...
from .views import (OnGoingBidDetail,OnGoingBidsList,BidView, CreateSellRequest,RequestUpdateView,DeleteCollectable,CollectableList, CollectableDetails, UserCreateAPIView, UserProfile, UserProfileUpdate  )
